...
/**
 * Oblicza wzrost liczby zgonów w USA w roku 2021 
 * w stosunku do średniej z lat 2018 i 2019.
 * Różnica w stosunku do klasy ZgonyUSATygodniowo2021 jest taka,
...
*/
public class ZgonyTygodniowo2021_1
{
	...
	{
		ZgonyUSATygodniowo1.setNazwaPlikuWyj("zgony2021us.txt");
		ZgonyUSATygodniowo1.setNazwaPlikuKom("komunikaty2021us.txt");
		ZgonyUSATygodniowo1.setNazwaPlikuIndeks("indeks2021.txt");
		...
		/* dane za rok 2021 */
		ZgonyUSATygodniowo1.czytajLiczbyZgonow3(LiczbyZgonow3, "Weekly_Provisional_Counts_of_Deaths_by_State_and_Select_Causes__2020-2022.csv", "2021");

		// ostatni parametr false oznacza, żeby 53-go tygodnia nie sumować, true oznacza sumować
		ZgonyUSATygodniowo1.zapiszStatystyke("NazwaStanu,Srednia2018_2019,2021,ZmianaStan,ZmianaStanProc,PoziomSzczepien,IndeksRestr,LiczbaSumowanychTygodni,\r\n","2021",false);	
	}
