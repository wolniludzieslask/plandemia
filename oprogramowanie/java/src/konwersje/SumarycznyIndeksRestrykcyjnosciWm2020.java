 ...
 * zgony_wm_sz_ir2020suma_ind.csv. Patrz opis
 * zgony_wm_sz_ir2020suma_ind.ods.czytaj, jak otrzymano plik
 * zgony_wm_sz_ir2020suma_ind.csv.
 * 
 * Zapisuje dane w formacie 
 * NazwaKraju,ZmianaProc,SumIndeks
 * 
 * Wartość sumarycznego indeksu restrykcyjności przetestowałem
 * dla Mongolii w pliku zgony_wm_sz_ir2020suma_ind.ods
 * obliczyłem wyrażenie =SUMA(F89:M89;S89) (OpenOffice)
 * 
 */
public class SumarycznyIndeksRestrykcyjnosciWm2020
{
	...
	private static String NazwaPlikuWej = "zgony_wm_sz_ir2020suma_ind.csv";
	private static String NazwaPlikuWyj = "zgony_wm_sz_ir2020suma_ind1.csv";
	...
	public static void zapiszDane()
	{
		...
		try
		{
			...
			while ((s = br.readLine()) != null)
			{
				...
				double C1 = Double.parseDouble(tab[5]);
				double C2 = Double.parseDouble(tab[6]);
				double C3 = Double.parseDouble(tab[7]);
				double C4 = Double.parseDouble(tab[8]);
				double C5 = Double.parseDouble(tab[9]);
				double C6 = Double.parseDouble(tab[10]);
				double C7 = Double.parseDouble(tab[11]);
				double C8 = Double.parseDouble(tab[12]);
				double H6 = Double.parseDouble(tab[18]);
