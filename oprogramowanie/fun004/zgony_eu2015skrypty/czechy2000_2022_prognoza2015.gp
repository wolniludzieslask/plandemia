...
set title "Zgony w Czechach w latach 2000-2022"

stats [2015:2019] 'czechy1946_2022.csv' using 1:2 prefix "A"
...
plot 'czechy1946_2022.csv' using 1:2 with linespoints title "zgony rocznie" lt 7 lc rgb "cyan",\
...
set output "Czechy2000_2022_prognoza2015.png"
replot
set output
set terminal pop
