...
set title "Zgony w Andorze w latach 2000-2022"
...
plot 'andora1948_2022.csv' using 1:2 with linespoints title "zgony rocznie" lt 7 lc rgb "cyan",\
...
set output "Andora2000_2022_prognoza2015.png"
replot
set output
set terminal pop
