...
set xrange [1973:2025]
set ylabel "liczba zgonów rocznie"
set key center bottom horizontal outside
set grid

set title "Zgony na Cyprze w latach 1974-2022"

stats [2015:2019] 'cypr1974_2022.csv' using 1:2 prefix "A"
...
plot 'cypr1974_2022.csv' using 1:2 with lines title "zgony rocznie" lc rgb "cyan",\
...
set output "Cypr1974_2022_prognoza2015.png"
replot
set output
set terminal pop
