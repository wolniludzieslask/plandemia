...
set title "Zgony w Bułgarii w latach 1946-2022"
...
plot 'bulgaria1946_2022.csv' using 1:2 with lines title "zgony rocznie" lc rgb "cyan",\
...
set output "Bulgaria1946_2022_prognoza2015.png"
replot
set output
set terminal pop
