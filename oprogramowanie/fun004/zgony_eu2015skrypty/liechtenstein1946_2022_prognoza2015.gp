...
set title "Zgony w Liechtensteinie w latach 1946-2022"
...
plot 'liechtenstein1946_2022.csv' using 1:2 with lines title "zgony rocznie" lc rgb "cyan",\
...
set output "Liechtenstein1946_2022_prognoza2015.png"
replot
set output
set terminal pop
