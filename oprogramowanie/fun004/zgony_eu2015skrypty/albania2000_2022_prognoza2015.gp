...
set title "Zgony w Albanii w latach 2000-2022"

stats [2015:2019] 'albania1950_2022.csv' using 1:2 prefix "A"
...
plot 'albania1950_2022.csv' using 1:2 with linespoints title "zgony rocznie" lt 7 lc rgb "cyan",\
...
set output "Albania2000_2022_prognoza2015.png"
replot
set output
set terminal pop
