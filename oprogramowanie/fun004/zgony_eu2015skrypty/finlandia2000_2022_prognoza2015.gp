...
set title "Zgony w Finlandii w latach 2000-2022"
...
plot 'finlandia1946_2022.csv' using 1:2 with linespoints title "zgony rocznie" lt 7 lc rgb "cyan",\
...
set output "Finlandia2000_2022_prognoza2015.png"
replot
set output
set terminal pop
