...
set xrange [1947:2025]
set ylabel "liczba zgonów rocznie"
set key center bottom horizontal outside
set grid

set title "Zgony w Andorze w latach 1948-2022"

stats [2015:2019] 'andora1948_2022.csv' using 1:2 prefix "A"
...
plot 'andora1948_2022.csv' using 1:2 with lines title "zgony rocznie" lc rgb "cyan",\
...
set output "Andora1948_2022_prognoza2015.png"
replot
set output
set terminal pop
